...
const cardVariants = [
    {
        id: 1,
        color: "Black",
        variantName: "Matte Black Metal",
        hex: "#1A1A1A",
        price: 50000,
        image: "/images/black-card.png",
        thumbnails: ["/images/black-card.png", "/images/black-card.png", "/images/black-card.png"],
    },
    {
        id: 2,
        color: "Gold",
        variantName: "Gold Metal",
        hex: "#D4AF37",
        price: 50000,
        image: "/images/gold-card.png",
        thumbnails: ["/images/gold-card.png", "/images/gold-card.png", "/images/gold-card.png"],
    },
    {
        id: 3,
        color: "Silver",
        variantName: "Silver Metal",
        hex: "#C0C0C0",
        price: 50000,
        image: "/images/silver-card.png",
        thumbnails: ["/images/silver-card.png", "/images/silver-card.png", "/images/silver-card.png"],
    },
];

const CardDetails = () => {
    const navigate = useNavigate();
    const [selectedVariant, setSelectedVariant] = useState(cardVariants[0]);
    const [mainImage, setMainImage] = useState(cardVariants[0].image);
